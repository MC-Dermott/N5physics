...
from topics.dynamics.projectile_higher     import (
    ...
    generate_projectile_s4_time_from_highest_point,
    generate_projectile_s5_max_height,
    generate_projectile_s5_displacement_from_launch,
    generate_projectile_s5_displacement_from_highest_point,
    generate_projectile_s6_horizontal_distance,
    generate_projectile_s6_time_to_distance,
    generate_projectile_s6_horizontal_velocity,
)
    ...
    "Higher": {
        ...
        "Our Dynamic Universe (Part 2)": {
            "Projectile Motion": {
                ...
                "4 — Time from Highest Point (Different Height)": generate_projectile_s4_time_from_highest_point,
                "5 — Maximum Height":                          generate_projectile_s5_max_height,
                "5 — Displacement from Launch":                generate_projectile_s5_displacement_from_launch,
                "5 — Displacement from Highest Point":         generate_projectile_s5_displacement_from_highest_point,
                "6 — Horizontal Distance":                     generate_projectile_s6_horizontal_distance,
                "6 — Time to a Horizontal Distance":           generate_projectile_s6_time_to_distance,
                "6 — Horizontal Velocity":                     generate_projectile_s6_horizontal_velocity,
                "7 — Exam Style: Same Height":                 generate_projectile_a_same_height,
                "7 — Exam Style: Given Height and Time":       generate_projectile_b_given_height_time,
                "7 — Exam Style: Time to Peak, then Range":    generate_projectile_c_time_then_range,
                "7 — Exam Style: Time to Peak, then Height":   generate_projectile_d_time_then_height,
                "7 — Exam Style: Horizontal Distance Target":  generate_projectile_e_horizontal_backwards,
                "7 — Exam Style: Given Flight Time":           generate_projectile_f_given_time_clearance,
                "7 — Exam Style: Explain":                     generate_projectile_explain,
            },
