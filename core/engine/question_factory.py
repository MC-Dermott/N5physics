...
from topics.dynamics.projectile_higher     import (
    ...
    generate_projectile_s1_components,
    generate_projectile_s2_time_same_height,
    generate_projectile_s2_time_from_highest_point,
    generate_projectile_s3_max_height,
    generate_projectile_s3_displacement_from_launch,
    generate_projectile_s3_displacement_from_highest_point,
    generate_projectile_s4_horizontal_distance,
    generate_projectile_s4_time_to_distance,
    generate_projectile_s4_horizontal_velocity,
)
...
QUAL_REGISTRY = {
    ...
    "Higher": {
        ...
        "Our Dynamic Universe (Part 2)": {
            "Projectile Motion": {
                "1 — Velocity Components":                     generate_projectile_s1_components,
                "2 — Time to Highest Point (Same Height)":     generate_projectile_s2_time_same_height,
                "2 — Time from Highest Point (Different Height)": generate_projectile_s2_time_from_highest_point,
                "3 — Maximum Height":                          generate_projectile_s3_max_height,
                "3 — Displacement from Launch":                generate_projectile_s3_displacement_from_launch,
                "3 — Displacement from Highest Point":         generate_projectile_s3_displacement_from_highest_point,
                "4 — Horizontal Distance":                     generate_projectile_s4_horizontal_distance,
                "4 — Time to a Horizontal Distance":           generate_projectile_s4_time_to_distance,
                "4 — Horizontal Velocity":                     generate_projectile_s4_horizontal_velocity,
                "5 — Exam Style: Same Height":                 generate_projectile_a_same_height,
                "5 — Exam Style: Given Height and Time":       generate_projectile_b_given_height_time,
                "5 — Exam Style: Time to Peak, then Range":    generate_projectile_c_time_then_range,
                "5 — Exam Style: Time to Peak, then Height":   generate_projectile_d_time_then_height,
                "5 — Exam Style: Horizontal Distance Target":  generate_projectile_e_horizontal_backwards,
                "5 — Exam Style: Given Flight Time":           generate_projectile_f_given_time_clearance,
                "5 — Exam Style: Explain":                     generate_projectile_explain,
            },
